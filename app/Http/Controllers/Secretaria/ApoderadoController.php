        ...
        foreach ($apoderados as $apoderado ) {
            $datosapoderado=$apoderado->persona;
                ...
                $actionButton = '<div class=" action-buttons">
                    <a class="blue"  href="'.route("Secretaria.Apoderado.Show",["apoderado"=>$datosapoderado["nrodocumento"]]).'" >
                    <i class="ace-icon fa fa-search-plus bigger-130"></i>
                    </a>

                    <a class="green" href="'.route("Secretaria.Apoderado.Edit",["apoderado"=>$datosapoderado["nrodocumento"]]).'" >
