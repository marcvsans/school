@extends('layouts.Secretaria',['title'=>'Secretaria | Alumno','headertitle'=>'Alumno','viewtitle'=>'Ver','page'=>'Alumno'])
														...
														<div class="space-2"></div>
															<div class="profile-user-info profile-user-info-striped ">
																<div class="profile-info-row">
																	<div class="profile-info-name">Estado Academico </div>

																	<div class="profile-info-value">
																		<span>{{$Alumno->estadoacademico}}</span>
																	</div>
																</div>
																<div class="profile-info-row">
																	<div class="profile-info-name">Apoderado </div>

																	<div class="profile-info-value">  
																		<span>{{$Alumno->datosApoderado->persona->nombres ." ".$Alumno->datosApoderado->persona->apellidos}}</span>
																	</div>
																</div>
...
<script type="text/javascript">
		...
		$('#alumno-show').addClass('active').removeClass('hide'); 
