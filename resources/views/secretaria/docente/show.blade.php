@extends('layouts.director',['title'=>'Director | Docente ','headertitle'=>'Docente','viewtitle'=>'Ver','page'=>'Docente'])
...
<script type="text/javascript">
		...
		$('#docente-show').addClass('active').removeClass('hide'); 
