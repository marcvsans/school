@extends('layouts.Secretaria',['title'=>'Secretaria | Apoderado','headertitle'=>'Apoderado','viewtitle'=>'Apoderado Nuevo','page'=>'Registrar Apoderado'])
...
@component('components.js.validator-check',['MethodName'=>'checkapoderado','RutaCheck'=>route('Secretaria.Persona.Check'),'data'=>"{_token:token,nrodocumento : value,model:'apoderado' }"])
@endcomponent
