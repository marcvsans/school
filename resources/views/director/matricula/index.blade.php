@extends('layouts.director',['title'=>'Director | Matricula','headertitle'=>'Matricula','viewtitle'=>'Todos','page'=>'Matricula'])
...
@component('components.js.select-search',['name'=>'#alumno','ruta'=>route('Director.Alumno.Search')])
	...
	@component('components.js.table',['route'=>route('Director.Matricula.Retrieve')])
