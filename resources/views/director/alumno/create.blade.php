...
@section('script')
  ...
  <script type="text/javascript">
	...
	jQuery(function($) {
		...
		@component('components.js.select-search',['name'=>'#apoderado2','ruta'=>route('Director.Apoderado.Search')])
...
@component('components.js.validator-check',['MethodName'=>'checkalumno','RutaCheck'=>route('Director.Persona.Check'),'data'=>"{_token:token,nrodocumento : value,model:'alumno' }"])
@endcomponent
