@extends('layouts.director',['title'=>'Director | Director','headertitle'=>'Director','viewtitle'=>'Ver','page'=>' Director'])
...
<script type="text/javascript">
		...
		$('#director-show').addClass('active').removeClass('hide'); 
