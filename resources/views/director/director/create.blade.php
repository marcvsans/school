@extends('layouts.director',['title'=>'Director | Director','headertitle'=>'Director','viewtitle'=>'Director Nuevo','page'=>' Registrar Director'])
...
<div class="row">
	<div class="col-xs-12">
		...
		'formId'=>'form-create',
		'id'=>'widget',
		'title'=>'Formulario de Registro de Directores'])
...
@section('script')
  ...
  <script type="text/javascript">
	...
	$('#menu-persona').addClass('active open');
		...
		$('#director-create').addClass('active');               
...
@component('components.js.validator-check',['MethodName'=>'checkdirector','RutaCheck'=>route('Director.Persona.Check'),'data'=>"{_token:token,nrodocumento : value,model:'director' }"])
@endcomponent
	...
	@component('components.js.validate-form')
      ...
      @slot('rules')
		...
		nrodocumento: {required: true,number:true, maxlength:11, minlength:8, checkdirector: true, checkpersona:true }, 
	...
	@component('components.js.validate-form')
		...
		@slot('rules')
		nrodocumento: {required: true, number:true, maxlength:11, minlength:8, checkdirector: true }
		...
		@slot('valid')
			...
			@component('components.js.ajax-submit')
			    ...
			    @slot('rutaAjax')
					'{!! route('Director.Director.Store2') !!}'
				@endslot
			    @slot('data') 
					formData
				@endslot
