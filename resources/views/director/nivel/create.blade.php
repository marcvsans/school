	...
	<div class="col-xs-12">
			<div class="widget-box widget-color-blue3" >
				<div class="widget-header">
					<h5 class="widget-title">Formulario de Registro de docentes</h5>
...
@section('script')
  ...
  <script type="text/javascript">
       		...
       		if(!ace.vars['touch']) {
				...
				// 	{type: 'image', name: 'Fotografia Por  defecto', path: 'http://localhost:8080/colegio%20pdo/assets/images/avatars/user.jpg'}
