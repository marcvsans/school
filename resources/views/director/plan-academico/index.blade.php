@extends('layouts.director',['title'=>'Director | Plan Academico','headertitle'=>'Plan Academico','viewtitle'=>'Todos','page'=>' Plan Academico'])
...
<div class="space-12"></div>
 	@component('components.table',['title'=>'Planes Academicos'])
			<th>Nombre</th>
			<th>Nivel</th>
			<th>Estado</th>
			<th>Asignar</th>
...
<div id="modal-registro" class="modal">
	<div class="modal-dialog" >
		...
		'formId'=>'form-create',
		'id'=>'widget',
		'title'=>'Formulario de Registro de Plan Academico'])
		 	 	  @slot('toolbar')
	  <a href="#" >
	  ...
	  @slot('body')
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-sm-9">
						<div class="clearfix">
							<input type="text" class="letras col-xs-12 col-sm-8" placeholder="plan academico xyz ..." class="col-xs-12 col-sm-6" id="nombre" name="nombre"  />
						</div>
					</div>
...
@section('script')
 <script src="{{ asset('assets/js/initinput.js')}}"></script>
  <script type="text/javascript">
	...
	$('#menu-plan_academico-todos').addClass('active'); 
			
			
	@component('components.js.table',['route'=>route('Director.PlanAcademico.Retrieve')])
	...
	@endslot
       ...
       @slot('valid')
		...
		@component('components.js.ajax-submit')
		    ...
		    @slot('rutaAjax')
				'{!! route('Director.PlanAcademico.Store') !!}'
			@endslot
	        @slot('data')
				formData
			@endslot
