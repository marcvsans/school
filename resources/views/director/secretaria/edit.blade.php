@extends('layouts.director',['title'=>'Director | Secretaria','headertitle'=>'Secretaria','viewtitle'=>$Persona->nombres ." ". $Persona->apellidos,'page'=>'Secretaria'])
...
@section('script')
  ...
  <script type="text/javascript">
	...
	$('#secretaria-edit').addClass('active').removeClass('hide');   
	  ...
	  @endslot
       ...
       @slot('valid')
		...
		@component('components.js.ajax-submit')
		    ...
		    @slot('rutaAjax')
				'{!! route('Director.Secretaria.Update',["Secretaria"=>"$Persona->nrodocumento"]) !!}'
			@endslot
	        @slot('data')
				formData
			@endslot
