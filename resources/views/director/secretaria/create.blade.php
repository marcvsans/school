@extends('layouts.director',['title'=>'Director | Secretaria','headertitle'=>'Secretaria','viewtitle'=>'Nuevo','page'=>'Secretaria'])
...
@section('script')
  ...
  <script type="text/javascript">
	...
	$('#menu-persona').addClass('active open');
		...
		$('#secretaria-create').addClass('active');               
...
@component('components.js.validator-check',['MethodName'=>'checksecretaria','RutaCheck'=>route('Director.Persona.Check'),'data'=>"{_token:token,nrodocumento : value,model:'secretaria' }"])
@endcomponent
      ...
      @slot('rules')
		...
		nrodocumento: {required: true,number:true, maxlength:11, minlength:8, checksecretaria: true, checkpersona:true }, 
	  ...
	  @endslot
       ...
       @slot('valid')
		...
		@component('components.js.ajax-submit')
		    ...
		    @slot('rutaAjax')
				'{!! route('Director.Secretaria.Store') !!}'
			@endslot
	        @slot('data')
				formData
			@endslot
	...
	@component('components.js.validate-form')
		...
		@slot('rules')
		nrodocumento: {required: true, number:true, maxlength:11, minlength:8, checksecretaria: true }
		@endslot
		...
		@slot('valid')
			...
			@component('components.js.ajax-submit')
			    ...
			    @slot('rutaAjax')
					'{!! route('Director.Secretaria.Store2') !!}'
				@endslot
			    @slot('data') 
					formData
				@endslot
