@extends('layouts.director',['title'=>'Director | Secretaria','headertitle'=>'Secretaria','viewtitle'=>'Ver','page'=>'Secretaria'])
...
<script type="text/javascript">
		...
		$('#secretaria-show').addClass('active').removeClass('hide'); 
