@extends('layouts.director',['title'=>'Director | Apoderado','headertitle'=>'Apoderado','viewtitle'=>'Apoderado Nuevo','page'=>'Registrar Apoderado'])
...
<div class="row">
	...
	@component('components.widget-box', [
		...
		'formId'=>'form-create',
		'id'=>'widget',
		'title'=>'Formulario de Registro de Apoderados'])
	  ...
	  @slot('body')
			...
			<div class="form-group">
				...
				<div class="col-xs-12 col-sm-9">
					<div class="clearfix">
						<input type="text" name="ocupacion" id="ocupacion"  class="col-xs-12 col-sm-6"   >
					</div>
				</div>
...
<div id="modal-registro" class="modal">
 <div class="modal-dialog" >
	  ...
	  @slot('body')
			...
			<div class="form-group">
				<label class="control-label col-xs-12 col-sm-4 no-padding-right" for="email">Ocupacion :</label>
				<div class="col-xs-12 col-sm-8">
					<div class="clearfix">
					<input type="text" name="ocupacion" id="ocupacion2"  class="col-xs-10 col-sm-8" >
					</div>
				</div>
				<span class="block input-icon input-icon-right">
				</span>
...
@component('components.js.validator-check',['MethodName'=>'checkapoderado','RutaCheck'=>route('Director.Persona.Check'),'data'=>"{_token:token,nrodocumento : value,model:'apoderado' }"])
@endcomponent
	...
	@component('components.js.validate-form')
      ...
      @slot('rules')
		...
		nrodocumento: {required: true,number:true, maxlength:11, minlength:8, checkapoderado: true, checkpersona:true }, 
	  ...
	  @endslot
       ...
       @slot('valid')
		...
		@component('components.js.ajax-submit')
		    ...
		    @slot('rutaAjax')
				'{!! route('Director.Apoderado.Store') !!}'
			@endslot
	        @slot('data')
				formData
			@endslot
	...
	@component('components.js.validate-form')
		...
		@slot('rules')
		nrodocumento: {required: true, number:true, maxlength:11, minlength:8, checkapoderado: true },
		ocupacion:{required:true}
		@endslot
		...
		@slot('valid')
			...
			@component('components.js.ajax-submit')
			    ...
			    @slot('rutaAjax')
					'{!! route('Director.Apoderado.Store2') !!}'
				@endslot
			    @slot('data') 
					formData
				@endslot
