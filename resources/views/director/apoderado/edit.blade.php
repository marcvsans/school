@extends('layouts.director',['title'=>'Director | Apoderado','headertitle'=>'Apoderado','viewtitle'=>$Persona->nombres ." ". $Persona->apellidos,'page'=>'Apoderado'])
      ...
      @slot('rules')
       ...
       @slot('valid')
		...
		@component('components.js.ajax-submit')
		    ...
		    @slot('rutaAjax')
				'{{ route("Director.Apoderado.Update",["alumno"=>"$Persona->nrodocumento"]) }}'
			@endslot
	        @slot('data')
				formData
			@endslot
